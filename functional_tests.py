...
class NewVisitorTest(unittest.TestCase):
    ...
    def test_can_start_a_list_and_retrieve_it_later(self):
        ...
        # Edith wonders whether the site will remember her list. Then she sees that site has generated a unique URL for her -- there is some explanatory text to that 
        # effect.
